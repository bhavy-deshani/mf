class Header {
    ...
    this.element.innerHTML = `
      ...
      <header class="fixed-top bg-white" id="top">
          <div class="custom-header-container">
              ...
              <nav class="custom-navbar">
                  <ul class="p-0 m-0">
                      ...
                      <li><a href="research-daily-market-insights.html" class="fs--14 fw-medium">Research</a></li>
          ...
          <img 
              ...
              alt="Language Icon" 
              class="img-fluid m-y" width="16" height="16"
 ...
 <li class="custom-dropdown-parent"><a href="#" onclick="toggleDropdown(event)">Research <svg xmlns="http://www.w3.org/2000/svg"
              ...
              <li><a href="research-daily-market-insights.html">Research</a></li>
  ...
  <div class="position-fixed bottom-0 end-0 pb-md-2  z-9 col-4 col-md-3 col-lg-2 col-xl-1">
